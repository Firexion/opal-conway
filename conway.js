...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2, grid = nil;

  Opal.add_stubs(['$require', '$attr_reader', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$>=', '$context', '$+', '$*', '$-', '$page_x', '$page_y', '$[]', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$new', '$on', '$get_cursor_position', '$x', '$y', '$fill_cell', '$find', '$unfill_cell', '$draw_canvas', '$add_event_listener']);
  self.$require("opal");
  ...
  (function($base, $super) {
    ...
    def.$initialize = function() {
      ...
      return self.max_y = (self.$width()['$/']($scope.get('CELL_WIDTH'))).$floor();
    };
...
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        ...
        return self.$fill_cell(x, y);}, TMP_1.$$s = self, TMP_1), $a).call($b, "click");
...
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        return self.$unfill_cell(x, y);}, TMP_2.$$s = self, TMP_2), $a).call($c, "dblclick");
  ...
  grid.$draw_canvas();
  return grid.$add_event_listener();
})(Opal);

...
Opal.modules["grid"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$blank_state', '$draw_canvas', '$add_event_listener', '$new', '$each', '$[]=', '$max_y', '$max_x', '$>=', '$context', '$+', '$==', '$fill_cell', '$[]', '$state', '$*', '$-', '$page_x', '$page_y', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$on', '$get_cursor_position', '$x', '$y', '$<<', '$seed', '$find', '$unfill_cell', '$delete']);
  self.$require("opal");
  ...
  (function($base, $super) {
    ...
    def.$initialize = function() {
      ...
      self.max_x = (self.$height()['$/']($scope.get('CELL_HEIGHT'))).$floor();
      self.max_y = (self.$width()['$/']($scope.get('CELL_WIDTH'))).$floor();
      self.state = self.$blank_state();
      self.seed = [];
      self.$draw_canvas();
      return self.$add_event_listener();
    };
    ...
    def.$blank_state = function() {
      ...
      ($a = ($b = ($range(0, self.$max_x(), false))).$each, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.$max_y(), false))).$each, $a.$$p = (TMP_2 = function(y){var self = TMP_2.$$s || this;
if (y == null) y = nil;
        return h['$[]='](x, y, 0)}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      return h;
    };
    ...
    def.$redraw_canvas = function() {
      ...
      self.$draw_canvas();
      return ($a = ($b = self.$state()).$each, $a.$$p = (TMP_3 = function(cell, liveness){var self = TMP_3.$$s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
    ...
    def.$fill_cell = function(x, y) {
      ...
      return self.$context().fillRect(x.$floor()['$+'](1), y.$floor()['$+'](1), $scope.get('CELL_WIDTH')['$-'](1), $scope.get('CELL_HEIGHT')['$-'](1));
    };
    ...
    def.$unfill_cell = function(x, y) {
      ...
      x = x['$*']($scope.get('CELL_WIDTH'));
      y = y['$*']($scope.get('CELL_HEIGHT'));
      return self.$context().clearRect(x.$floor()['$+'](1), y.$floor()['$+'](1), $scope.get('CELL_WIDTH')['$-'](1), $scope.get('CELL_HEIGHT')['$-'](1));
    };
    ...
    def.$get_cursor_position = function(event) {
      ...
      if ((($a = (($b = event.$page_x(), $b !== false && $b !== nil ?event.$page_y() : $b))) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        y = event['$[]']("clientY")['$+'](doc.$scrollTop())['$+'](doc.$documentElement().$scrollTop());
      };
      x = x['$-'](self.$canvas().offsetLeft);
      y = y['$-'](self.$canvas().offsetTop);
      x = (x['$/']($scope.get('CELL_WIDTH'))).$floor();
      y = (y['$/']($scope.get('CELL_HEIGHT'))).$floor();
      return $scope.get('Coordinates').$new($hash2(["x", "y"], {"x": x, "y": y}));
    };

    return (def.$add_event_listener = function() {
      var $a, $b, TMP_4, $c, TMP_5, self = this;

      ($a = ($b = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_4 = function(event){var self = TMP_4.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_4.$$s = self, TMP_4), $a).call($b, "click");
      return ($a = ($c = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_5 = function(event){var self = TMP_5.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_5.$$s = self, TMP_5), $a).call($c, "dblclick");
    }, nil) && 'add_event_listener';
  })(self, null);
  return (function($base, $super) {
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$extend', '$def_delegators', '$add_enter_event_listener', '$new', '$tick', '$==', '$[]', '$state', '$!', '$is_alive?', '$reduce', '$map', '$to_proc', '$-', '$+', '$<', '$population_at', '$include?', '$>', '$is_dead?', '$is_underpopulated?', '$is_living_happily?', '$is_overpopulated?', '$can_reproduce?', '$state=', '$new_state', '$redraw_canvas', '$each', '$[]=', '$get_state_at', '$on', '$enter_pressed?', '$seed', '$run', '$which']);
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("grid");
  ...
  (function($base, $super) {
    ...
    def.$run = function() {
      ...
      return ($a = ($b = $scope.get('Interval')).$new, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$tick()}, TMP_1.$$s = self, TMP_1), $a).call($b);
    };
    ...
    def.$population_at = function(x, y) {
      ...
      return ($a = ($b = [self.$state()['$[]']([x['$-'](1), y['$-'](1)]), self.$state()['$[]']([x['$-'](1), y]), self.$state()['$[]']([x['$-'](1), y['$+'](1)]), self.$state()['$[]']([x, y['$-'](1)]), self.$state()['$[]']([x, y['$+'](1)]), self.$state()['$[]']([x['$+'](1), y['$-'](1)]), self.$state()['$[]']([x['$+'](1), y]), self.$state()['$[]']([x['$+'](1), y['$+'](1)])]).$map, $a.$$p = "to_i".$to_proc(), $a).call($b).$reduce("+");
    };

    def['$is_underpopulated?'] = function(x, y) {
      var $a, self = this;
    ...
    def.$new_state = function() {
      var $a, $b, TMP_2, self = this, new_state = nil;

      new_state = $scope.get('Hash').$new();
      ($a = ($b = self.$state()).$each, $a.$$p = (TMP_2 = function(cell, _){var self = TMP_2.$$s || this;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      return new_state['$[]='](cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1)))}, TMP_2.$$s = self, TMP_2), $a).call($b);
      return new_state;
    };
    ...
    def.$add_enter_event_listener = function() {
      ...
      return ($a = ($b = $scope.get('Document')).$on, $a.$$p = (TMP_3 = function(event){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (event == null) event = nil;
      if ((($a = self['$enter_pressed?'](event)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = ($b = self.$seed()).$each, $a.$$p = (TMP_4 = function(x, y){var self = TMP_4.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
          return self.$state()['$[]=']([x, y], 1)}, TMP_4.$$s = self, TMP_4), $a).call($b);
          return self.$run();
          } else {
          return nil
    ...
    return (def['$enter_pressed?'] = function(event) {
      var self = this;

      return event.$which()['$=='](13);
    }, nil) && 'enter_pressed?';
  })(self, null);
  return game = $scope.get('Conway').$new($scope.get('Grid').$new());
})(Opal);

//# sourceMappingURL=conway.map
